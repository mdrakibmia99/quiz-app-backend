### **Live Project Link:**
 [Backend Live link](https://blog-project-theta-ten.vercel.app/)
...
```
git clone https://github.com/mdrakibmia99/blog-project-backend.git
...
create .env file in root dir  and set database uri
